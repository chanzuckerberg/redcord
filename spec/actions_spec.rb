...
describe Redcord::Actions do
  let!(:klass) do
    Class.new(T::Struct) do
      ...
      attribute :integer, T.nilable(Integer), index: true
      attribute :string, T.nilable(String), index: true
      attribute :symbol, T.nilable(Symbol), index: true
      attribute :time, T.nilable(Time), index: true
